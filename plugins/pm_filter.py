...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/how123download')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ GROUP ⚡', url='https://t.me/sbmovietamzha'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/Tamilthalaiva3')
        ], [
